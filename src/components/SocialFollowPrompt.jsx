    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 p-4 backdrop-blur-xl">
      <GlassCard className="relative w-full max-w-md motion-safe:animate-spring-in">
        ...
        <button
          ...
          onClick={close}
          aria-label="Fermer"
          className="focus-ring squishy absolute -bottom-4 -right-4 flex h-11 w-11 items-center justify-center rounded-full text-slate-400/50 transition-colors duration-200 hover:text-slate-100"
        >
